...
class AudioThemesHandler:
    ...
    def configure(self, *args, **kwargs):
        ...
        self._cached_config = {
            ...
            "clipboard_announce_mode": user_config.get("clipboard_announce_mode", "both"),
            "clipboard_delay": user_config.get("clipboard_delay", 50),
            "clipboard_copy": user_config.get("clipboard_copy", True),
            "clipboard_cut": user_config.get("clipboard_cut", True),
            "clipboard_paste": user_config.get("clipboard_paste", True),
            "clipboard_selectall": user_config.get("clipboard_selectall", True),
            "clipboard_undo": user_config.get("clipboard_undo", True),
            "clipboard_redo": user_config.get("clipboard_redo", True),
            "clipboard_pasteplain": user_config.get("clipboard_pasteplain", True),
            "clipboard_redo2": user_config.get("clipboard_redo2", True),
            "clipboard_copy_sound": user_config.get("clipboard_copy_sound", True),
            "clipboard_cut_sound": user_config.get("clipboard_cut_sound", True),
            "clipboard_paste_sound": user_config.get("clipboard_paste_sound", True),
            "clipboard_selectall_sound": user_config.get("clipboard_selectall_sound", True),
            "clipboard_undo_sound": user_config.get("clipboard_undo_sound", True),
            "clipboard_redo_sound": user_config.get("clipboard_redo_sound", True),
            "clipboard_pasteplain_sound": user_config.get("clipboard_pasteplain_sound", True),
            "clipboard_redo2_sound": user_config.get("clipboard_redo2_sound", True),
            "clipboard_copy_speech": user_config.get("clipboard_copy_speech", True),
            "clipboard_cut_speech": user_config.get("clipboard_cut_speech", True),
            "clipboard_paste_speech": user_config.get("clipboard_paste_speech", True),
            "clipboard_selectall_speech": user_config.get("clipboard_selectall_speech", True),
            "clipboard_undo_speech": user_config.get("clipboard_undo_speech", True),
            "clipboard_redo_speech": user_config.get("clipboard_redo_speech", True),
            "clipboard_pasteplain_speech": user_config.get("clipboard_pasteplain_speech", True),
            "clipboard_redo2_speech": user_config.get("clipboard_redo2_speech", True),
            "clipboard_custom_texts": user_config.get("clipboard_custom_texts", "{}"),
            # System sounds
            ...
            "sys_all_usb": user_config.get("sys_all_usb", True),
            "sys_battery_low_threshold": user_config.get("sys_battery_low_threshold", 20),
            "sys_battery_critical_threshold": user_config.get("sys_battery_critical_threshold", 10),
            ...
            # Navigation Layer config
            "navLayerPassThrough": user_config.get("navLayerPassThrough", True),
            "navLayerTimeout": user_config.get("navLayerTimeout", True),
            "navLayerPlaySounds": user_config.get("navLayerPlaySounds", True),
            "navLayerEnabledModes": user_config.get("navLayerEnabledModes", ""),
