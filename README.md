...
- **Audio Beacon / Sonar:** Drop a spatial audio marker and navigate with real-time sonar pings.
...
| NVDA+Shift+A | Audio Themes command layer (h=help, t=themes, p=rules, s=state verbosity, c=heading level, o=speech order) |
...
| Alt+Arrows | Sentence / phrase navigation |
